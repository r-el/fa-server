  ...
  try {
    ...
    if (isMongoDBAvailable()) {
      ...
      try {
        ...
        const todaysEvents = await mongoGridFSService.db.collection("events").countDocuments({
          timestamp: {
            $gte: today,
            $lt: tomorrow,
          },
        ...
        const highRiskAlerts = await mongoGridFSService.db.collection("events").countDocuments({
          timestamp: {
            $gte: today,
            $lt: tomorrow,
          },
